...
(function dartProgram() {
  ...
  X = {
    main: function() {
      ...
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new X.main_closure(), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
  ...
  X.main_closure.prototype = {
    call$1: function(e) {
      ...
      $.type = t1[t3];
      t2 = C.JSString_methods.substring$2(t1, 0, t2 - 2);
      $.number = t2;
      t2 = $.number = P.int_parse(t2);
      t1 = $.type;
      if (t1 === "g") {
        t1 = $.$get$output();
        t2 = H.S(t2) + " kg=";
        t3 = H.numTypeCheck($.number);
        if (typeof t3 !== "number")
          return H.iae(t3);
        (t1 && C.LabelElement_methods).setInnerHtml$1(t1, t2 + C.JSDouble_methods.toStringAsFixed$1(2.2 * t3, 3) + "ib");
      } else if (t1 === "b") {
        t1 = $.$get$output();
        t2 = H.S(t2) + " ib=";
        t3 = H.numTypeCheck($.number);
        if (typeof t3 !== "number")
          return t3.$mul();
        (t1 && C.LabelElement_methods).setInnerHtml$1(t1, t2 + C.JSNumber_methods.toStringAsFixed$1(t3 * 0.45, 3) + "kg");
      } else {
        t1 = $.$get$output();
        (t1 && C.LabelElement_methods).setInnerHtml$1(t1, "\u8acb\u8f38\u5165\u6578\u5b57\u52a0\u4e0a kg \u6216 ib!");
      }
      return;
    },
    $signature: 18
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "tempInput", "$get$tempInput", function() {
      return H.interceptedTypeCheck(W.querySelector("#F"), "$isInputElement");
    });
